#!/usr/bin/env node
// V7.2 性能优化版 - 二进制序列化 + 热点预加载 + 中间件精简

const BinarySerializer = require('./performance/binary-serializer.js');
